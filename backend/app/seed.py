"""Seed dataset for the Navigator API.

This mirrors the shapes the frontend expects (camelCase JSON). It stands in
for the real data sources described in SPEC.md — the registry, local git
state, the GitHub API, and per-project ``navigator.yaml`` files. Swap the
functions in :mod:`app.api` to read those sources when they come online; the
JSON contract the frontend consumes stays the same.
"""
        ...
        "sessions": [
            {
                ...
                "reflection": (
                    ...
                    "Deferred: Search/filter — spec is ambiguous about whether filtering is client-side or "
                    "server-side. Left a TODO in SearchBar.tsx. Recommend clarifying in SPEC.md.\n"
                    "Decisions outside spec: Used TanStack Query for data fetching — not specified, chose it "
                    "over raw fetch for cache management."
                ),
            },
            {
                "date": "2026-05-20",
            ...
            },
            {
                ...
                "reflection": (
                    ...
                    "Ambiguity: Spec didn't say what to do about duplicate releases (same album, different "
                    "pressings). Defaulted to keeping all; flagged in TODOs."
                ),
            },
        ],
        "spec": "SPEC.md",
        ...
        "sessions": [
            {
                ...
                "outcome": "complete",
                "reflection": (
                    "Completed: width: 100% on hero, aspect-ratio set explicitly. Bumped body to 17px and "
                    "reduced measure to 64ch.\nDecisions: Switched body font to Newsreader."
                ),
            },
            {
                "date": "2026-05-22",
                ...
                "outcome": "complete",
                "reflection": "Completed: /writing route with frontmatter-driven filtering. Cached at edge.",
            },
        ],
        "spec": "SPEC.md",
        ...
        "sessions": [
            {
                ...
                "outcome": "complete",
                "reflection": (
                    "Completed: Lowered temp to 0.4 for the editor pass; quality up, repetition down. "
                    "Backtest in artifacts/2026-05-23-eval.md."
                ),
            },
        ],
        "spec": "SPEC.md",
        ...
        "sessions": [
            {
                ...
                "outcome": "blocked",
                "reflection": (
                    "Blocked: argo CLI doesn't expose context flag the way I assumed. Need to either embed "
                    "kubernetes client directly or shell out with KUBECONFIG env. Leaning toward env approach "
...
READY_TASKS: list[dict[str, Any]] = [
    {
        ...
        "source": {
            ...
            "quote": (
                "Spec is ambiguous about whether filtering is client-side or server-side. "
                "Recommend clarifying in SPEC.md."
            ),
        },
...
PORTFOLIO: dict[str, dict[str, Any]] = {
    "spincd": {
        ...
        "recentCommits": [
            ...
            {
                "sha": "1c8e3d0",
                "message": "TypeScript strict mode + ESLint flat config",
                "time": "yesterday",
                "branch": "feat/react-frontend",
            },
            {
                "sha": "0f1b22a",
                "message": "Discogs import: 542 albums, rate-limited fetch",
                "time": "3d ago",
                "branch": "main",
            },
            {
                "sha": "8e447d1",
                "message": "schema: albums + tracks + labels",
                "time": "5d ago",
                "branch": "main",
            },
            {
                "sha": "b91c042",
                "message": "FastAPI scaffold + SQLAlchemy 2.0 base",
                "time": "1w ago",
                "branch": "main",
            },
        ],
        ...
        "artifacts": [
            {
                "id": "a1",
                "kind": "image",
                "name": "collection-mock.png",
                "time": "3d ago",
                "thumb": "linear-gradient(135deg, #B48EAD, #7a4f72)",
            },
            {
                "id": "a2",
                "kind": "image",
                ...
                "time": "1w ago",
                "thumb": "linear-gradient(135deg, #88C0D0, #5E81AC)",
            },
            {"id": "a3", "kind": "doc", "name": "schema.sql", "time": "1w ago"},
            {
                "id": "a4",
                "kind": "doc",
                "name": "ADR-001-tanstack-query.md",
                "time": "yesterday",
            },
            {"id": "a5", "kind": "doc", "name": "discogs-api.md", "time": "2w ago"},
        ],
        "notes": (
            "## Pinned\n\n- Filtering is **client-side for now**, decision pending in Phase 2 (see SPEC "
            "§Open Questions).\n- TanStack Query is the only non-spec'd dependency — flagged in 2026-05-23 "
            "session reflection.\n\n## Backlog\n\n- Sleeve scan storage: local FS for solo use; revisit if I "
            "ever multi-user.\n- Barcode scan flow — needs phone-first prototype.\n\n## Questions I owe "
            'future-me\n\n- Is the "many pressings of same album" dedupe heuristic actually right? Spot-check '
            "20 albums."
        ),
    },
    "sean-michael.dev": {
        ...
        "recentCommits": [
            ...
            {
                "sha": "9aa12fe",
                "message": "writing index with tag filtering, frontmatter cached",
                "time": "2d ago",
                "branch": "main",
            },
            {
                "sha": "7e2c1a9",
                "message": "bump Newsreader, switch /reading to grid",
                "time": "5d ago",
                "branch": "main",
            },
        ],
        ...
        "artifacts": [
            {
                "id": "b1",
                "kind": "image",
                "name": "hero-redesign.png",
                "time": "5d ago",
                "thumb": "linear-gradient(135deg, #8FBCBB, #4a7878)",
            },
            {
                "id": "b2",
                "kind": "doc",
                "name": "writing-frontmatter.md",
                "time": "2d ago",
            },
        ],
        "notes": (
            "## Pinned\n\n- Body font is Newsreader 17px / 64ch measure — settled.\n- /writing is the canonical "
            "content surface; everything else is curated.\n\n## To draft\n\n- November reading roundup\n- Notes "
            "on running solo SaaS w/ Claude Code"
        ),
    },
    "ai-digest": {
        "visibility": "private",
        ...
        "deploy": {
            "env": "homelab k3s · cronjob",
            "status": "healthy",
            "url": "digest.lab.local",
            "version": "0.7.1",
            "lastDeploy": "5d ago",
            "uptime": "21d",
        },
        ...
        "recentCommits": [
            ...
            {
                "sha": "f02bb91",
                "message": "evals: 7-day backtest of editor temperature settings",
                "time": "3d ago",
                "branch": "main",
            },
            {
                "sha": "c43e2af",
                "message": "deduplicate cross-source story clustering",
                "time": "1w ago",
                "branch": "main",
            },
        ],
        ...
        "artifacts": [
            {
                "id": "c1",
                "kind": "doc",
                "name": "ADR-003-editor-temp.md",
                "time": "yesterday",
            },
            {
                "id": "c2",
                "kind": "doc",
                "name": "2026-05-23-eval.md",
                "time": "yesterday",
            },
    ...
    "argo-mcp": {
            ...
            "runs": [
                {
                    ...
                    "duration": "0m 38s",
                    "commit": "0e4d83f",
                    "reason": "test_context_passthrough",
                },
                {
                    "id": 21,
                    "status": "passing",
        ...
        "recentCommits": [
            ...
            {
                "sha": "5d8121c",
                "message": "initial MCP server + submit/watch/abort",
                "time": "3w ago",
                "branch": "main",
            },
        ],
        ...
        "artifacts": [
            {"id": "d1", "kind": "doc", "name": "mcp-protocol.md", "time": "3w ago"}
        ],
        "notes": (
            "## Open question\n\nKube context pass-through — embed kubernetes client directly, or shell out with "
    ...
    "navigator": {
        ...
        "artifacts": [
            ...
            },
            {
                "id": "e3",
                "kind": "image",
                "name": "design-portal.png",
                "time": "today",
                "thumb": "linear-gradient(135deg, #88C0D0, #5E81AC)",
            },
        ],
        "notes": (
            "## What this is\n\nA personal GitOps control plane for solo AI-assisted development. ArgoCD is to "
            "Kubernetes what Navigator is to your codebase.\n\n## Phase 1 scope\n\n- Inbox (this)\n- Project "
...
def bootstrap() -> dict[str, Any]:
    """The full payload the frontend loads on startup."""
    return {
        "projects": PROJECTS,
        "feed": FEED,
